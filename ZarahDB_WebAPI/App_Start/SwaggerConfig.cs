...
namespace ZarahDB_WebAPI
{
    ...
    public class SwaggerConfig
    {
        ...
        public static void Register()
        {
            ...
            GlobalConfiguration.Configuration
                .EnableSwagger(c =>
                {
                    ...
                    //
                    c.OrderActionGroupsBy(new ControllerScopeComparer());
                ...
                .EnableSwaggerUi(c =>
                {
                    ...
                    //
                    c.InjectStylesheet(thisAssembly, "ZarahDB_WebAPI.CustomSwagger.CustomSwagger.css");
                    ...
                    //
                    c.CustomAsset("index", thisAssembly, "ZarahDB_WebAPI.CustomSwagger.index.html");
        ...
        {
            return $@"{AppDomain.CurrentDomain.BaseDirectory}\bin\ZarahDB_WebAPI.XML";
        }
    }

    /// <summary>
    ///     Class ControllerScopeComparer.
    /// </summary>
    public class ControllerScopeComparer : IComparer<string>
    {
        /// <summary>
